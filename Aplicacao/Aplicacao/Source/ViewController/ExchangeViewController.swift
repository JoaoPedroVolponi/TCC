...
class ExchangeViewController: UIViewController {
    ...
    @objc func buttonChecked() {
        ...
        if wallet.validationDataBuy(exchange: exchange, textField: textField) {
            ...
            self.screenExchange?.buttonComprar.backgroundColor = UIColor(hex: "2CCD4F")  // Cor para "comprar"
        }
        else {
            self.screenExchange?.buttonComprar.backgroundColor = UIColor(hex: "2CCD4F").withAlphaComponent(0.5)
        ...
        if wallet.validationDataSell(exchange: exchange, textField: textField) {
            ...
            self.screenExchange?.buttonVender.backgroundColor = UIColor(hex: "CD3F2C")  // Cor para "vender"
        }
        else {
            self.screenExchange?.buttonVender.backgroundColor = UIColor(hex: "CD3F2C").withAlphaComponent(0.5)
